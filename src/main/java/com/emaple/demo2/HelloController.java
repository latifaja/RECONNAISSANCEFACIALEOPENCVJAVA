...
public class HelloController {
    ...
    void handleGererAdmin() {
        ...
        boolean ver=DatabaseManager.adimnEx("lat","lat");

        if (ver){ try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("admin-tab.fxml"));
            ...
            alert.setContentText("seul les admin est l'accée");
            alert.showAndWait();
    ...
    public void handleGererUser() {
        ...
        timeline = new Timeline(
                new KeyFrame(Duration.seconds(0.088), e -> {  // 30 FPS update rate (1/30 = 0.033)
                    Mat frame = new Mat();
                    ...
                    if (!frame.empty()) {
                        ...
                        // If a face is detected, try to identify the user
